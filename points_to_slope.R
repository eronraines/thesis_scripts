###
# This code pulls the slope information for a set of spatial points
###
### 

require(raster)

# this is the shapefile of slope, download shapfile, 
#put in directory, point here
NZ_slope <-raster("/Users/eronraines/Desktop/Chapter 3 data/lris-lenz-slope-GTiff/lenz-slope.tif") 
...
##
## this chunk manipulates points and slope map data
##
...
combine_slope <-extract(NZ_slope,pointtoplot)
